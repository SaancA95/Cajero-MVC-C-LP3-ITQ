...
{
    //Clase que se utiliza para gestionar las transacciones 
    public class transaccion
    {
        //Variables miembros de la clase de visibilidad privada
        ...
        //unafirma(listayordendetiposdedatosenparametros)diferente.
